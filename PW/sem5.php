...
<body style="font-size: 20px;">
    ...
    <body>
        <center>
        <table>
        <div class="center" style="margin-top: 155px">
    ...
    $sql = "SELECT * FROM COURSES where SEM=5 AND (COURSE_CODE='20CS5AIP' OR COURSE_CODE='20CS5PCCON' OR COURSE_CODE='20CS5PCUSP' OR COURSE_CODE='20CS5PCSEG' OR COURSE_CODE='20CS5HSSPM' OR COURSE_CODE='20CS5PWPW3' OR COURSE_CODE='20CS5NCNC5')";
    $sql1 = " SELECT COURSE_CODE FROM COURSES where SEM=5 and (COURSE_CODE='20CS5PEIOT' OR COURSE_CODE='20CS5PEAJJ' OR COURSE_CODE='20CS5PEADS')";
    $sql2 = " SELECT COURSE_NAME FROM COURSES where SEM=5 and (COURSE_CODE='20CS5PEIOT' OR COURSE_CODE='20CS5PEAJJ' OR COURSE_CODE='20CS5PEADS')";
    $sql3 = " SELECT COURSE_CODE FROM COURSES where SEM=5 and (COURSE_CODE='20CS5PEAAG' OR COURSE_CODE='20CS5PESCD' OR COURSE_CODE='20CS5PEACA')";
    $sql4 = " SELECT COURSE_NAME FROM COURSES where SEM=5 and (COURSE_CODE='20CS5PEAAG' OR COURSE_CODE='20CS5PESCD' OR COURSE_CODE='20CS5PEACA')";
