...
<body style="font-size: 20px;">
    ...
    $sql = "SELECT * FROM COURSES where SEM=7 AND (COURSE_CODE='21CS7HSCFI' OR COURSE_CODE='21IC7BSBIE' OR COURSE_CODE='21CS7PCIMC' OR COURSE_CODE='21CS7PWPP1' OR COURSE_CODE='21CS7SRSEM' OR COURSE_CODE='21CS7NCNC7')";
    $sql1 = " SELECT COURSE_CODE FROM COURSES where SEM=7 and (COURSE_CODE='21CS7PEBLC' OR COURSE_CODE='21CS7PENSD' OR COURSE_CODE='21CS7PEMMC')";
    $sql2 = " SELECT COURSE_NAME FROM COURSES where SEM=7 and (COURSE_CODE='21CS7PEBLC' OR COURSE_CODE='21CS7PENSD' OR COURSE_CODE='21CS7PEMMC')";
    $sql3 = " SELECT COURSE_CODE FROM COURSES where SEM=7 and (COURSE_CODE='21CS7PEDIS' OR COURSE_CODE='21CS7PESDP' OR COURSE_CODE='21CS7PECCT')";
    $sql4 = " SELECT COURSE_NAME FROM COURSES where SEM=7 and (COURSE_CODE='21CS7PEDIS' OR COURSE_CODE='21CS7PESDP' OR COURSE_CODE='21CS7PECCT')";
    $sql5 = " SELECT COURSE_CODE FROM COURSES where SEM=7 and (COURSE_CODE='21CS7OEDAS' OR COURSE_CODE='21CS7OEPYP')";
    $sql6 = " SELECT COURSE_NAME FROM COURSES where SEM=7 and (COURSE_CODE='21CS7OEDAS' OR COURSE_CODE='21CS7OEPYP')";
